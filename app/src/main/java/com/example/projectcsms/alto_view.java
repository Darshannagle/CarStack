...
public class alto_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(v -> startActivity(new Intent(alto_view.this,BookACar.class)));

        Previous.setOnClickListener(v -> viewflipper1.showPrevious());

        Next.setOnClickListener(v -> viewflipper1.showNext());
    }
}